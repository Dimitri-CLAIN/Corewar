...
op_t op_tab[] = {
    {"live", 1, {{T_DIR, 0}, 0}, 1, 10, "alive"},
    {"ld", 2, {{T_DIR, T_IND, 0}, {T_REG, 0}, 0}, 2, 5, "load"},
    ...
    "load index"},
    {"sti", 3, {{T_REG, 0}, {T_REG, INDEXE, 0}, {INDEXE, T_REG, 0}, 0}, 11, 25,
    "store index"},
    {"fork", 1, {{INDEXE, 0}, 0}, 12, 800, "fork"},
    {"lld", 2, {{T_DIR, T_IND, 0}, {T_REG, 0}, 0}, 13, 10, "long load"},
    {"lldi", 3, {{INDEXE, 0}, {INDEXE, 0}, {T_REG, 0}, 0}, 14, 50,
    "long load index"},
    {"lfork", 1, {{INDEXE, 0}, 0}, 15, 1000, "long fork"},
    {"aff", 1, {{T_REG, 0}, 0}, 16, 2, "aff"},
    {0, 0, {{0}}, 0, 0, 0}
};
